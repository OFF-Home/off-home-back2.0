...
describe('/GET SearchByRadi:', () => {
    before(function(done){
        db.serialize(() => {
            ...
            db.run(sql4,['josep@gmail.com','C/Font',25,'19-04-2021 18:00:00','Running',10,'Play','playing','19-04-2021 19:00:00'], () => {
                done();
            });
        });
    });
    ...
    it('should return the activity', (done) => {
        chai.request(url)
            .get('/activitats/searchbyradi?latitud=41.400922&altitud=2.174286&distance=3')
    ...
    it('should not return anything', (done) => {
        chai.request(url)
            .get('/activitats/searchbyradilatitud=41.400922&altitud=2.174286&distance=0.1')
            .end(function(err,res) {
...
describe('/GET Participants Activitat:', () => {
    before(function (done) {
        db.serialize(() => {
            ...
            db.run(sql, ['jess@gmail.com', 'C/Font', 25, '19-04-2021 18:00:00', 'Running', 10, 'Play', 'playing', '19-04-2021 19:00:00']);
            db.run(sql, ['jess@gmail.com', 'C/Font', 25, '30-04-2021 18:00:00', 'Running', 10, 'Play', 'playing', '30-04-2021 19:00:00']);
